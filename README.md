...
---
<!-- Attempts to auto-play (muted is required for most browsers) -->
<video autoplay muted loop playsinline controls preload="metadata" style="max-width:100%; height:auto;">
